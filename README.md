...
Most important step of entire workflow. In this example, the file [test_run_multiome.csv](./1_upstream_snakefiles/01_prep_metadata/test_run_multiome.csv) is used in the config.yaml file - any file name can be used just edit config file accordingly.
